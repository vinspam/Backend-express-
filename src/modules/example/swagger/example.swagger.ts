        ...
        'multipart/form-data': {
          schema: {
            ...
            properties: {
              ...
              type: { type: 'string', enum: Object.keys(EXAMPLE_ENUM), required: false },
            },
          },
        },
      },
...
export default {
  '/example': getExamples,
  '/example/{id}': Object.assign({}, editExample, getExample, deleteExample),
  '/example/name': getExampleByName,
};
